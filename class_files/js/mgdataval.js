...
function getMenu(){
	do {
   // Display choices, ask for user input,
   // convert to uppercase
   menuChoice = prompt("Enter C to clear the local storage of the math game. \n"
      + "Enter H to display the high scores \n"
   ...
   if (menuChoice == "C") {
      ...
      alert("ERROR: Please enter C, H, or S \n");
   }
} while (menuChoice != "S");
...
if (input == answer) {
  ...
  window.alert("ERROR: Enter a valid number for the answer.");
  return;
}
